...
public class MnistImagePipelineMongoAddNeuralNet {

    private static Logger log = LoggerFactory.getLogger((MnistImagePipelineMongoAddNeuralNet.class));
    ...
    public static void main(String[] args) throws Exception {
        ...
        MongoDaoDL4J daoTrain = new MongoDaoDL4J(conn.getMongoDatabase(), "imgTraining", "label", "imgTrainingContent", "contentId");
        MongoDaoDL4J daoTest = new MongoDaoDL4J(conn.getMongoDatabase(), "imgTest", "label", "imgTestContent", "contentId");
